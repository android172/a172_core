...
typedef CORE_NAMESPACE::uint8   u8;
typedef CORE_NAMESPACE::uint16  u16;
typedef CORE_NAMESPACE::uint32  u32;
typedef CORE_NAMESPACE::uint64  u64;
typedef CORE_NAMESPACE::uint128 u128;

typedef CORE_NAMESPACE::int8   i8;
typedef CORE_NAMESPACE::int16  i16;
typedef CORE_NAMESPACE::int32  i32;
typedef CORE_NAMESPACE::int64  i64;
typedef CORE_NAMESPACE::int128 i128;

typedef CORE_NAMESPACE::float32  f32;
typedef CORE_NAMESPACE::float64  f64;
typedef CORE_NAMESPACE::float128 f128;
